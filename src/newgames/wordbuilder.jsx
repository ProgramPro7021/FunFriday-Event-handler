  ...
  return (
    <div className="wordbuilder-page">
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Play Word Builder, an exciting word scramble game. Unscramble scrambled letters and build words faster than the clock. Perfect for team building and classroom activities."
        />
        <meta
          name="keywords"
          content="word builder game, word scramble, word puzzle, team building games, classroom games, fun friday activities, brain training"
        />
      </Helmet>
